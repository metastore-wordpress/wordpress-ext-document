...
/**
 * Class WP_EXT_Document_Template
 */
class WP_EXT_Document_Template extends WP_EXT_Document {
 ...
 *
 * @return WP_EXT_Document_Template
 */
function WP_EXT_Document_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Document_Template;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Document_Template(), 'run' ] );
