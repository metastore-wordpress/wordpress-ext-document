...
/**
 * Class WP_EXT_Document_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Document_Theme extends WP_EXT_Document {
 ...
 *
 * @return WP_EXT_Document_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Document_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Document_Theme;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Document_Theme(), 'run' ] );
